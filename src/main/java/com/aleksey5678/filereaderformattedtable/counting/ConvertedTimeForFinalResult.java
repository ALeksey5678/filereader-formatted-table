...
public class ConvertedTimeForFinalResult {
    ...
    public Map<String, String> convertTimeFromMillisecondsToMinutes(Map<String, Duration> timeInMillisecondsByAbbreviation) {

        Map<String, String> convertedTimeOfRacingByAbbreviation = new HashMap<>();

        for (Map.Entry<String, Duration> nameAndTime : timeInMillisecondsByAbbreviation.entrySet()) {
            String abbreviations = nameAndTime.getKey();

            Duration duration = nameAndTime.getValue();
